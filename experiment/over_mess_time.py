...
for workload in workloads:
    ...
    legend_elements = [Line2D([0], [0], color=colors[0], label='Normal Events'),
                    ...
                    Line2D([0], [0], marker='^', color='w', markerfacecolor='gray', markersize=10, label='TCP policy'),
    ...
    plt.tight_layout()
    plt.savefig(f'e4/s_{workload}_p1-3_message_throughput.pdf', bbox_inches='tight', pad_inches=0.05, dpi=300)
