...
# normal_df = pd.read_csv('e1_w2/normal_overhead_throughput.csv')
p1_df = pd.read_csv('e1_w2/p1_overhead_throughput.csv')
p2_df = pd.read_csv('e1_w2/p2_overhead_throughput.csv')
p3_df = pd.read_csv('e1_w2/p3_overhead_throughput.csv')
...
all_data = pd.concat([p1_priority, p2_priority, p3_priority, p1_normal, p2_normal, p3_normal])
...
plt.ylim(bottom=0)
plt.savefig('e1_w2/e1_w2_overhead_throughput.pdf', bbox_inches='tight', pad_inches=0.05, dpi=300)
# plt.show()
